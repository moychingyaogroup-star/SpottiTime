...
Build your schedule like puzzles! SpottiTime is a personal time planner and social scheduling application designed to help you manage your time effectively while incorporating gamification and social features.
...
SpottiTime is a static frontend application that can be run easily on a local development server.
...
Guidelines for contributing to SpottiTime.
