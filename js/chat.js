...
async function addFriendByTag() {
  ...
  try {
    ...
    showToast('Could not send request: '+(e.message || 'Please try again.'));
  }
}
...
async function renderFriendRequests() {
  ...
  try {
    ...
    targets.forEach(el => { el.innerHTML = '<div style="padding:12px;color:#EF4444">Could not load friend requests.</div>'; });
  }
}
